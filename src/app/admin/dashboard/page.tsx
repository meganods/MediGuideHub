            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-[#C9A15A]/25 p-6 rounded-2xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button
                  onClick={() => {
                    const auditRows = [
                      { section: "Content Quality", status: "Ready", score: "95/100", details: "30+ Original Guides" },
                      { section: "Technical SEO", status: "Ready", score: "98/100", details: "Schema & Crawling Configured" },
                      { section: "E-E-A-T Compliance", status: "Ready", score: "100/100", details: "Disclaimers & Review Workflows Active" },
                      { section: "Legal Completeness", status: "Ready", score: "100/100", details: "10 Legal Pages Active" }
                    ].map(row => `
                      <tr>
