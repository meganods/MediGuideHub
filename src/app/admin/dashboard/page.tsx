...
function AdminContent() {
  ...
  const handleExportMessagesPDF = () => {
    ...
    const htmlContent = `
      <html>
        <head>
          <title>MediGuide Hub - Visitor Inquiries Report</title>
          <style>
        ...
        <body>
          <h1>MediGuide Hub — Visitor Inquiries Inventory Report</h1>
          <table>
            <thead>
              <tr>
          ...
          <div class="footer">
            Document generated by MediGuide Hub Admin Console on ${new Date().toLocaleDateString()} at ${new Date().toLocaleTimeString()}.
          </div>
        </body>
      </html>
    `;
  ...
  const handleExportSubscribersPDF = () => {
    ...
    const htmlContent = `
      <html>
        <head>
          <title>MediGuide Hub - Newsletter Subscribers Report</title>
          <style>
            body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #113f48; padding: 40px; line-height: 1.6; }
            h1 { color: #113f48; border-bottom: 2px solid #C9A15A; padding-bottom: 10px; margin-bottom: 30px; font-size: 28px; }
            table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        ...
        <body>
          <h1>MediGuide Hub — Newsletter Subscribers Inventory Report</h1>
          <table>
            <thead>
              <tr>
                      ...
                      <button
                        onClick={() => {
                          ...
                          const htmlContent = `
                            <html>
                              <head>
                                <title>MediGuide Hub - Blog Articles Export</title>
                                <style>
                                  body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #113f48; padding: 40px; line-height: 1.6; }
                                  h1 { color: #113f48; border-bottom: 2px solid #C9A15A; padding-bottom: 10px; margin-bottom: 30px; font-size: 28px; }
                                  table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
                              ...
                              <body>
                                <h1>MediGuide Hub — Articles Inventory Report</h1>
                                <table>
                                  <thead>
                                    <tr>
                                      <th>Title</th>
                      ...
                      <button
                        onClick={() => {
                          ...
                          const htmlContent = `
                            <html>
                              <head>
                                <title>MediGuide Hub - Categories Inventory Export</title>
                                <style>
                                  body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #113f48; padding: 40px; line-height: 1.6; }
                                  h1 { color: #113f48; border-bottom: 2px solid #C9A15A; padding-bottom: 10px; margin-bottom: 30px; font-size: 28px; }
                                  table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
                              ...
                              <body>
                                <h1>MediGuide Hub — Categories Inventory Report</h1>
                                <table>
                                  <thead>
                                    <tr>
                                      <th>Category Name</th>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const htmlContent = `
                        <html>
                          <head>
                            <title>MediGuide Hub - Google AdSense Readiness Audit</title>
                            <style>
                              body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #113f48; padding: 40px; line-height: 1.6; }
                              h1 { color: #113f48; border-bottom: 2px solid #C9A15A; padding-bottom: 10px; margin-bottom: 30px; font-size: 28px; }
                              table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
                          ...
                          <body>
                            <h1>MediGuide Hub — Google AdSense Pre-Flight Compliance Report</h1>
                            <table>
                              <thead>
                                <tr>
                                  <th>Section</th>
